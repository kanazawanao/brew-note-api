...
func Test_openapi_BrewNoteApiService(t *testing.T) {
	...
	t.Run("Test BrewNoteApiService CreateRecipe", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.BrewNoteApi.CreateRecipe(context.Background()).Execute()
	...
	t.Run("Test BrewNoteApiService GetRoastLevels", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BrewNoteApi.GetRoastLevels(context.Background()).Execute()
