...
type ApiGetRecipesRequest struct {
	ctx context.Context
	ApiService *BrewNoteApiService
}

func (r ApiGetRecipesRequest) Execute() ([]Recipe, *http.Response, error) {
	return r.ApiService.GetRecipesExecute(r)
}
...
レシピ一覧を取得します
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRecipesRequest
*/
func (a *BrewNoteApiService) GetRecipes(ctx context.Context) ApiGetRecipesRequest {
	return ApiGetRecipesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Recipe
func (a *BrewNoteApiService) GetRecipesExecute(r ApiGetRecipesRequest) ([]Recipe, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrewNoteApiService.GetRecipes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
